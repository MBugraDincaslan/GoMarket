...
func saveCategoryToFirebase (_ category: Category) {
    ...
    category.id = id
    FirebaseReferences(.Category).document(id).setData(categoryDictionaryFrom(category) as! [String : Any])
}
...
func downloadCategoriesFromFirebase(completion: @escaping (_ categoryArray: [Category])-> Void ) {
    ...
    FirebaseReferences(.Category).getDocuments { (snapshot, error) in
